  ...
  return (
    <div className="h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6">
      ...
      <form className="flex flex-col gap-6  flex-1 mb-6 ">
        <button className=" w-max p-2 shadow-md rounded-xl text-sm text-gray-500 bg-white ">Add a cover Images</button>
        ...
        <div className="flex items-center gap-4">
          ...
          <select name="cat" id="" className="p-2 rounded-xl bg-white shadow-md">
            ...
            <option value="so">Search Engines</option>
            <option value="marketing">Marketing</option>
          </select>
        </div>

        <textarea  className="p-4 rounded-xl bg-white shadow-md"  name="desc" placeholder="A Short Decription"></textarea>
